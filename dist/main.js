...
.nav {
  ...
  padding: 1rem;
  padding-top: 2rem;
  border-top: var(--Aquamarine) solid 5px;
...
`, "",{"version":3,"sources":["webpack://./src/style.css"],"names":[],"mappings":"AAAA;EACE,yBAAyB;EACzB;gBACc;EACd;iBACe;AACjB;AACA;EACE,yBAAyB;EACzB;gBACc;EACd;iBACe;AACjB;AACA;EACE,2BAA2B;EAC3B;gBACc;EACd;iBACe;AACjB;;AAEA;EACE,oBAAoB;EACpB,qBAAqB;EACrB,iBAAiB;EACjB,kBAAkB;AACpB;AACA;EACE,UAAU;EACV,QAAQ;EACR,eAAe;EACf,YAAY;EACZ,2BAA2B;AAC7B;;AAEA;EACE,YAAY;EACZ,aAAa;EACb,2BAA2B;EAC3B,mBAAmB;EACnB,oBAAoB;EACpB,kCAAkC;AACpC;AACA;EACE,wBAAwB;EACxB,gBAAgB;EAChB,+BAA+B;EAC/B,aAAa;EACb,sBAAsB;EACtB,2BAA2B;EAC3B,SAAS;EACT,aAAa;EACb,iBAAiB;EACjB,uCAAuC;;AAEzC;AACA;EACE,gBAAgB;EAChB,SAAS;EACT,QAAQ;EACR,6BAA6B;EAC7B,mBAAmB;EACnB,gBAAgB;EAChB,yBAAyB;EACzB,eAAe;AACjB;AACA;EACE,eAAe;EACf,2BAA2B;AAC7B;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,oCAAoC;AACtC;AACA;EACE,4BAA4B;EAC5B,eAAe;AACjB;AACA;EACE,UAAU;AACZ;AACA;EACE,yBAAyB;EACzB,gBAAgB;EAChB,iBAAiB;AACnB;AACA;EACE,aAAa;EACb,qBAAqB;EACrB,2BAA2B;EAC3B,SAAS;EACT,oCAAoC;AACtC;AACA;EACE,+BAA+B;AACjC;AACA;EACE,YAAY;AACd;AACA;EACE,iBAAiB;AACnB;AACA;EACE,eAAe;AACjB;;;AAGA;EACE,wBAAwB;EACxB,gBAAgB;EAChB,aAAa;EACb,sBAAsB;EACtB,gCAAgC;EAChC,aAAa;AACf;AACA;EACE,WAAW;EACX,uBAAuB;EACvB,aAAa;EACb,cAAc;AAChB;AACA;EACE,aAAa;EACb,mBAAmB;EACnB,4BAA4B;EAC5B,2BAA2B;EAC3B,WAAW;AACb;AACA;EACE,WAAW;EACX,YAAY;EACZ,uBAAuB;AACzB;AACA;EACE,YAAY;EACZ,uBAAuB;AACzB;AACA;EACE,uBAAuB;EACvB,uBAAuB;AACzB","sourcesContent":["@font-face {\n  font-family: 'Moon-light';\n  src: url(../dist/fonts/Moon/moon_light-webfont.woff)\n  format('woff');\n  src:url(../dist/fonts/Moon/moon_light-webfont.woff2)\n  format('woff2');\n}\n@font-face {\n  font-family: 'Muli-light';\n  src: url(../dist/fonts/Muli/muli-extralight-webfont.woff)\n  format('woff');\n  src: url(../dist/fonts/Muli/muli-extralight-webfont.woff2)\n  format('woff2');\n}\n@font-face {\n  font-family: 'Muli-Regular';\n  src: url(../dist/fonts/Muli/muli-webfont.woff)\n  format('woff');\n  src: url(../dist/fonts/Muli/muli-webfont.woff2)\n  format('woff2');\n}\n\n:root{\n  --Baby-blue: #E7F2F8;\n  --Aquamarine: #74BDCB;\n  --Salmon: #FFA384;\n  --Freesia: #EFE7BC;\n}\nbody {\n  padding: 0;\n  margin:0;\n  font-size: 14px;\n  height:100vh;\n  font-family: 'Muli-Regular';\n}\n\n.pageContainer {\n  height: 100%;\n  display: grid;\n  grid-template: 1fr/ 1fr 8fr;\n  padding-left: 10rem;\n  padding-right: 10rem;\n  background-color: var(--Baby-blue);\n}\n.nav {\n  grid-area: 1 / 1 / 2 / 2;\n  min-height: 80vh;\n  background-color: var(--Salmon);\n  display: flex;\n  flex-direction: column;\n  justify-content: flex-start;\n  gap: 2rem;\n  padding: 1rem;\n  padding-top: 2rem;\n  border-top: var(--Aquamarine) solid 5px;\n\n}\nbutton{\n  appearance: none;\n  padding:0;\n  margin:0;\n  border: transparent solid 2px;\n  border-radius: 12px;\n  background: none;\n  font-family: 'Moon-light';\n  font-size: 1rem;\n}\nbutton:hover{\n  cursor: pointer;\n  transform: translateX(-3px);\n}\n.homeLink{\n  display: flex;\n  align-items: center;\n  border-bottom: transparent solid 5px;\n}\n.homeLink:hover{\n  border-color: var(--Freesia);\n  cursor: pointer;\n}\n.siteIcon > img{\n  width:2rem;\n}\n.siteName{\n  font-family: 'Moon-light';\n  font-weight: 500;\n  font-size: 1.5rem;\n}\n.dateLists{\n  display: flex;\n  align-content: center;\n  justify-content: flex-start;\n  gap:.8rem;\n  border-bottom: 4px solid transparent;\n}\n.dateLists:hover{\n  border-color: var(--Aquamarine);\n}\n.dateLists > img{\n  width:1.5rem;\n}\n.dateLists > button{\n  font-size: 1.2rem;\n}\n.listCont{\n  margin-top:5rem;\n}\n\n\n.contentContainer {\n  grid-area: 1 / 2 / 2 / 3;\n  min-height: 80vh;\n  display: flex;\n  flex-direction: column;\n  background-color: var(--Freesia);\n  padding: 2rem;\n}\n.section {\n  height: 10%;\n  background-color: white;\n  padding: 3rem;\n  margin: 0.3rem;\n}\n.task {\n  display: flex;\n  align-items: center;\n  align-content: space-between;\n  justify-content: flex-start;\n  gap: 0.5rem;\n}\n.checkBox {\n  width: 1rem;\n  height: 1rem;\n  border: solid 2px green;\n}\n._completed > .checkBox {\n  border: none;\n  background-color: green;\n}\n._uncompleted > .checkBox {\n  background-color: white;\n  border: solid 2px green;\n}\n"],"sourceRoot":""}]);
// Exports
